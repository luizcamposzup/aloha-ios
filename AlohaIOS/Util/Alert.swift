...
class Alert: UIAlertController {
  ...
  @discardableResult
    static func showAlertError(viewController: UIViewController, title: String? = "Sorry", message: String?, preferredStyle: UIAlertController.Style = .alert, buttonTouched:((UIAlertAction)->Void)? = nil) -> UIAlertController {
